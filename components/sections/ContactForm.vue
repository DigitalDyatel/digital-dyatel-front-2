  ...
  <section class="contact-form">
    ...
    <div class="contact-form__container">
      ...
      <form autocomplete="off">
        ...
        <Button class="--large" type="submit" @click.prevent="onSubmit">Записаться на разбор репутации</Button>
        <ProcessingPersonalDataAgree button-text="Записаться на разбор репутации" />
